...
const RescheduleBookingScreen = ({ route, navigation }) => {
    ...
    useEffect(() => {
       console.log(bookingId,'data here')
    }, [dispatch])
    ...
    const handleCreateBooking = (addressId) => {
        ...
        navigation.navigate("ResheduleSummery", { addressId, selectedTab, selecteddate: selectedDate || customDate, selectedTime, description, serviceId:bookingId?.service_type_id, imagesToUpload ,  bookingId: bookingId?.booking_id,});
