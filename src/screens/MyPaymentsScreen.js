  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.imageContainer}>
        <Image
          source={require('../assets/pana.png')}  // replace this with your dummy PNG path
          style={styles.image}
          resizeMode="contain"
        />
      </View>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.title}>Upgrade Your Workflow</Text>
        <Text style={styles.subtitle}>
          Stay tuned for updates that will take your productivity to the next level!
        </Text>
      </View>
    </SafeAreaView>
  );
